...
Program Name: W.library.php
Description: Library page for workout page
...
<head>
  ...
  <link rel="stylesheet" href="W.library.css" />
...
<body>
    ...
    <div class="nav-container">
      <a href="memberHomepage.php" class="home-button"><i class="fas fa-home"></i></a>
        ...
        <ul class="nav-links">
          ...
          <li><a href="W.library.php" class="active">Workout Library</a></li>
  ...
  <div class="container">
    ...
    <div id="workoutLibrary" class="workout-library"></div>
    </div>
  <script src="W.library.js"></script>
